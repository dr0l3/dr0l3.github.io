...
import LLMStyleAddition from '@/components/llm-style-addition';

# Simple Problems Solved LLM Style

> **Note (written June 2023):** Some of the specifics here didn’t age well: “think step by step” is now effectively built into most LLM products, and basic math/coding tasks are often routed through tools/compilers/interpreters which makes them faster and less error-prone. The core idea still holds: many “stupid” model mistakes make more sense once you account for the model’s constraints and interface.
...
3. Move to the next digits and rinse repeat.
```
...
Try it yourself here with addition instead. 🤖

<LLMStyleAddition />

This used addition instead of multiplication. There aren't any timelimits either to make it more realistic a short time limit could be added (e.g. 5 seconds per digit).
