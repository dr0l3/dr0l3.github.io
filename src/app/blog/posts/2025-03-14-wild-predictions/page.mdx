...
[bolt.new](https://bolt.new) and [lovable.dev](https://lovable.dev) have both grown at an impressive pace, reaching [40M ARR](https://youtu.be/L22DtAHLmzs?si=f-t3RHzRQ_iwVFz7) and [30M ARR](https://youtu.be/DZtGxNs9AVg?si=lFrAfHE1vrqehNRw) respectively in less than six months. Why? what is driving this growth?
...
This process naturally takes more time and coordination, MUCH more. 
...
One way to look at this is that Figma has a 10B+ valuation.
Do you need a design tool if you can just use a prototype tool?
I don't know, but I see quite a few companies hiring design engineers rather than designers.
Given the pace at which AI improves will how long is there even a difference?
...
Of course, you wouldn't provide a blank canvas, but rather a default layout with some guardrails and sandboxing. 
Now, if a user wants to move a couple of buttons around, change colors, or adjust labels, they can do so. 
AI would make quick work of such requests, no technical skills required.
...
Yet another perpective is that say I create an app that does something really useful, but I am a terrible designer. 
...
Existing apps are in a similar situation. 
Think about how difficult it is to make design changes to existing apps. 
