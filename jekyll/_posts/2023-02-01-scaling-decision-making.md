...
In [a previous blog post,](https://dr0l3.github.io/scaling-software-team-productivity/) we tackled the problem of scaling the execution part of making software.
...
The ability to repeatedly put everyone into a conference room and have that be a productive use of time is a bit of a superpower.
...
These sorts of "invisible walls" are unavoidable and sometimes carry a significant cost.
...
We had these events in Kafka, but the team was a little hesitant to use these and instead wanted to periodically poll the database, a more familiar solution.
I had significant experience and could easily see how this would be a scaling challenge if certain enterprise customers got their hands on the product.
...
Anecdotally, my dad agrees and swears by Apple products because of this consistency.
I also wouldn't want to be on-call for a product that has microservices and no standardized monitoring.

At other times trying to force heterogeneity is more trouble than it is worth.
...
From a mental model perspective, it's possible to view centralized decision-making as a cost that has to be recouped later.
...
If too high a cost is flowed out of a team this leaves them vulnerable to being blocked by other teams.
...
One way to deal with this is to invite outsiders to meetings for sanity-checking decisions.
...
Amazon's famous 6 pagers are one example of how this can work.

A mistake I repeatedly see people make in these sorts of "can you give me feedback on this"-meetings is to skirt over the high-level view and go straight to details.
...
Favor graphical representations over text whenever possible.
